...
const SearchBar = () => {
  return (
    <section>
      ...
      {/* <div>
        <Card className="bg-light-white border border-gray-50 shadow-sm rounded-md p-4 mt-2 xl:mt-6 hover:shadow-md hover:border-paragraph-color cursor-pointer">
          <CardHeader>
            <CardTitle>
